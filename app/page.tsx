  ...
  return (
    <div className="flex flex-1 flex-col items-center px-5 py-16 sm:py-24">
      <header className="mb-12 w-full max-w-3xl">
        <div className="mb-5 inline-flex items-center gap-2 rounded-3 border border-border bg-fill-raised px-4 py-2 font-semibold text-ink-dim">
        ...
        <p className="mt-4 max-w-xl text-lg leading-relaxed text-ink-dim">
          ...
          dos öl. Välj ord, meningar eller stycken, så fixar Kumpsum resten.
        </p>
      </header>
